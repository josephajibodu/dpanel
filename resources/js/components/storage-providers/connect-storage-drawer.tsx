...
interface ConnectStorageDrawerProps {
...
export function ConnectStorageDrawer({
    types,
    trigger,
}: ConnectStorageDrawerProps) {
    ...
    return (
        ...
        >
            ...
            <SheetContent className="flex flex-col gap-0 overflow-y-auto sm:max-w-lg">
                <SheetHeader>
                    <SheetTitle>Connect Storage</SheetTitle>
                    <SheetDescription>
                ...
                >
                    <div className="space-y-2">
                        <Label htmlFor="type">Storage Provider</Label>
                        <Select
                            value={data.type}
